...
class Baseline_xlnet_re(nn.Module):
    def __init__(self, in_size=100, bi_hidden_size=300, bi_out_size=512,gc_size=300,at_size=600,
                 linear_hidden_size=300, out_size=1, head=1, num_layers=2, dropout=0.1,
                 bi=True):
        super(Baseline_xlnet_re, self).__init__()
        ...
        self.gcn1 = GCN(bi_hidden_size*2, gc_size,at_size,dropout)
