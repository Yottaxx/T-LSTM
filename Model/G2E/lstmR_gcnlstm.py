...
class GraphStatelstm(nn.Module):
    def __init__(self,vocab_len, in_size=300,lstm_h_size=1200, g_out_size=300,at_size=1200,l_h_size=300, out_size=1,
        ...
        self.lstm=nn.LSTM(in_size,in_size,num_layers=1,batch_first=True,bidirectional=True)
        ...
        self.lstm2=nn.LSTM(in_size*2,in_size*2,num_layers=1,batch_first=True,bidirectional=True)
        self.dropout = nn.Dropout(dropout)
